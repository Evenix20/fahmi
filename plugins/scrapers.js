...
if (config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'img ?(.*)', fromMe: true, onlyGroup: true}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'img ?(.*)', fromMe: false, onlyGroup: true}, (async (message, match) => { 
