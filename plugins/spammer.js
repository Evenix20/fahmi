...
Asena.addCommand({pattern: 'killspam', fromMe: false, desc: Lang.STOP_SPAMDESC}, (async (message, match) => {
...
Asena.addCommand({pattern: 'spam ?(.*)', fromMe: false, desc: Lang.SPAM_DESC}, (async (message, match) => {
