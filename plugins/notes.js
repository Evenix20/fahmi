...
Asena.addCommand({ pattern: 'save ?(.*)', fromMe: false, desc: Lang.SAVE_USAGE }, async (message, match) => {
...
Asena.addCommand({ pattern: 'deleteNotes', fromMe: false, desc: Lang.DELETE_USAGE }, async (message, match) => {
